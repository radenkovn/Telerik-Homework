...
function printArr(array) {
    array.forEach(function (item) {
        outputBox.value += item.toString() + '\r\n';
    });
}

function printResult() {
    var result = findOfAge(people);
    outputBox.value += 'The array contains only people of age - ' + result + '\r\n';
}

function findOfAge(people) {
    people = people.every(function (person) {
