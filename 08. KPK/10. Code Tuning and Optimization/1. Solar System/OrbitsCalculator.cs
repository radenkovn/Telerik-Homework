...
namespace SolarSystem
{
    class OrbitsCalculator : INotifyPropertyChanged
    {
        ...
        {
            //Took the calculation out of the loop
            var currentPosition = Days / EarthRotationPeriod;
            //Reduced the speed of rotation - it was actually wrong!
            //Removed the useless decimal conversion
            for (double step = 0; step < 360; step += 0.5)
            {
                EarthRotationAngle = step * currentPosition;
            }
